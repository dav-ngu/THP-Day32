...
12.times do |x|
    user = User.create(mail: "mail#{x}@yopmail.com", description: Faker::Lorem.sentence(word_count: 50, supplemental: false, random_words_to_add: 4), first_name: Faker::Name.first_name, last_name: Faker::Name.last_name)
    users << user
end
tp User.all
puts "Users created"
